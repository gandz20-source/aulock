      ...
      <UIProvider>
        ...
        <LiveClassroomProvider>
          <Routes>
            ...
            {/* Keeping old landing at /landing or inaccessible? Removed for now as Portal is entry */}

            {/* --- Protected App Routes --- */}
            {/* Any route starting with /app is wrapped in ProtectedLayout */}
            <Route path="/app" element={<ProtectedLayout />}>

              {/* The Index uses the LayoutSwitcher to decide where to go based on Platform & Role */}
              <Route index element={<LayoutSwitcher />} />

              {/* Stub / Placeholder Routes for new modules */}
            ...
            {/* Legacy/Direct access redirects - ensure backwards compatibility or catch-all */}
