...
export default function EliteTutorsWhiteboard() {
  const specialists = [
    { 
      ...
      bio: 'Especialista en álgebra, números, geometría, cálculo y resolución analítica de problemas.' 
    },
    { 
      name: 'Tutor Física', 
      ...
      bio: 'Especialista en dinámica, vectores, cinemática, energía y física aplicada.' 
    },
    { 
      name: 'Tutor Química', 
      subject: 'Química & Estructura Molecular', 
      ...
      bio: 'Especialista en estequiometría, fórmulas químicas, enlaces y reacciones.' 
    },
    { 
      ...
      bio: 'Especialista en algoritmos, código binario y pensamiento computacional.' 
    },
  ];
